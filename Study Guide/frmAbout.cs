...
namespace Uberware
{
  ...
  public class frmAbout : System.Windows.Forms.Form
  {
    ...
    // Constant values
    const string AppTitle = "Study Guide";
    const string AppDescription = "Study Guide is designed for students whose grades are not showing his or her best ability on exams and quizes.";
    ...
    private void frmAbout_Load(object sender, System.EventArgs e)
    {
      ...
      m_strProductVersion = Application.ProductVersion;
